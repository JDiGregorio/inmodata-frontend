    ...
    return (
        <div className={`rounded-md p-4 shadow-md ${style.background}`}>
            <div className="flex">
                ...
                <div className="ml-3">
                    <p className={`text-sm font-medium ${style.fontColor}`}>
                        {message}
                    </p>
                </div>
                ...
                <div className="ml-auto pl-3">
                    <div className="-mx-1.5 -my-1.5">
                        <button type="button" className={`inline-flex rounded-md ${style.background} p-1.5 ${style.iconColor} ${style.dismissBgColor} focus:outline-none focus:ring-2 ${style.dismissFocusRing} focus:ring-offset-2 ${style.dismissFocusRingOffset}`} onClick={onDismiss}>
