export const initialPermissions = {
	'user': { description: 'Usuarios', view: false, add: false, edit: false, delete: false },
	'role': { description: 'Roles', view: false, add: false, edit: false, delete: false },
	'permission': { description: 'Permisos', view: false, add: false, edit: false, delete: false },
	'institution': { description: 'Institución', view: false, add: false, edit: false, delete: false },
