...
export const GeneralInformationTab = (): React.ReactElement => {
    ...
    const [improvementArea, setImprovementArea] = useState<number>(0)
    const [landValue, setLandValue] = useState<number>(0)
    // const [utilizationRatio, setUtilizationRatio] = useState<number>(0)
    // const [averageSquareYard, setAverageSquareYard] = useState<number>(0)
    // const [averageSquareMeter, setAverageSquareMeter] = useState<number>(0)
    const [riskProfile, setRiskProfile] = useState<AggregateOption | null>(null)
    ...
    const handleCreateProperty = async () => {
        ...
        if (result.data) {
            ...
            const newPropertyId = result.data?.createProperty.id

            navigate(`/inmuebles/${newPropertyId}/editar`, {
                replace: true
            })
        }
    }
